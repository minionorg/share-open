...
var m = (e, t, r) => t in e ? g(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r;
var s = (e, t, r) => (m(e, typeof t != "symbol" ? t + "" : t, r), r);
function u(e) {
...
s(l, "DEFAULT_NOT_NAN_EX_MESSAGE", "\u9A8C\u8BC1\u7684\u503C\u4E0D\u662F\u6570\u5B57");
function w(e, t) {
  if (l.isString(e) === null)
    return !1;
  const f = /^(?:[-+]?(?:0|[1-9][0-9]*))$/, y = /^[-+]?[0-9]+$/, n = t || {}, o = Object.prototype.hasOwnProperty, p = (Object.prototype.hasOwnProperty.call(n, "zeroes") && !n.zeroes ? f : y).test(e), i = parseInt(e, 10);
...
function $(e, t) {
  ...
  return r.setDate(r.getDate() + (a("Number")(t) ? t : +t)), r;
}
export {
  $ as default
};
