...
function E(r, t) {
  if (a.isString(r) === null)
    return !1;
  const l = /^(?:[-+]?(?:0|[1-9][0-9]*))$/, p = /^[-+]?[0-9]+$/, n = t || {}, o = Object.prototype.hasOwnProperty, f = (Object.prototype.hasOwnProperty.call(n, "zeroes") && !n.zeroes ? l : p).test(r), i = parseInt(r, 10);
  return f && (!o.call(n, "min") || i >= n.min) && (!o.call(n, "max") || i <= n.max) && (!o.call(n, "lt") || i < n.lt) && (!o.call(n, "gt") || i > n.gt);
}
export {
  E as default
};
